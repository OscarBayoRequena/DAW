...
public class Factura {
    ...
    public Factura(String nombre,String apellidos,int dni,String direccion) {
        this.cliente= new Cliente(nombre,apellidos,dni,direccion);
        
    }

    public Factura(String numPieza, String descrip, int cantidad, double precioPorUnidad,
            String nombre,String apellidos,int dni,String direccion) {
